...
// Rota para obter as classificações da Serie A
...
// Rota para obter os próximos eventos da Serie A
router.get('/serie-a/lista', (0, cachingRoutes_1.default)(120), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// Rota para obter os resultados passados da Serie A
router.get('/serie-a/resultados', (0, cachingRoutes_1.default)(120), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { date } = req.query; // Obtém o parâmetro de data, se fornecido
