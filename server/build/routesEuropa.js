...
router.get('/liga-dos-campeoes/lista', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield fetch(`https://www.thesportsdb.com/api/v1/json/${process.env.API_KEY}/eventsnextleague.php?id=${leagueIds_1.leagueIds.championsLeague}`);
...
router.get('/liga-dos-campeoes/resultados', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield fetch(`https://www.thesportsdb.com/api/v1/json/${process.env.API_KEY}/eventspastleague.php?id=${leagueIds_1.leagueIds.championsLeague}`);
        const responseData = yield response.json();
        const arr = Object.entries(responseData.events).map(transformData_1.transformNextLastLeagueEvent);
        res.json(arr);
    }
